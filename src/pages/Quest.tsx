...
export function Quest(): ReactElement {
  ...
  if (!data?.quest)
    return <div className="alert alert-info">Quest not found</div>;
      ...
      <div className="flex justify-between items-center mb-4">
        <nav className="breadcrumbs text-sm">
          <ul>
            ...
            <li>
              <Link to="/quests" className="link-hover link-primary">
                {t('common:quests')}
              </Link>
            </li>
            <li className="text-base-content/60">{quest.name}</li>
          </ul>
        </nav>
      </div>
