...
export const ErrorAlert = ({
  ...
  customText,
  className = '',
}: ErrorAlertProps): ReactElement | null => {
      ...
      <div>
        ...
        >
          <path
            ...
            strokeWidth="2"
            d="M10 14l2-2m0 0l2-2m-2 2m2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"
          />
        </svg>
        <div>
...
export const NullDataAlert = ({
  data,
  customText,
  className = '',
}: NullDataAlertProps): ReactElement | null => {
  useTranslation('common');
      ...
      <div className={`alert alert-warning shadow-lg ${className}`}>
        <div>
          ...
          <div>
            ...
            <div className="text-xs">{customText}</div>
          </div>
        </div>
      </div>
    );
...
export const useDataQueryHandler = () => {
  ...
  const handleLoadingError = (
    ...
    if (data == null)
      return <ErrorMessage customText={notFoundText || t('notFound')} />;
    return null;
  };
